...
class _BusDetailsState extends State<BusDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<BusesProvider>(builder: (context, prov, _) {
      return Column(
        children: [
          Row(
          ...
          Container(
            ...
            child: SmoothScrollWeb(
              ...
              child: Scrollbar(
                child: prov.busesModel.buses[widget.index].trips.length == 0
                    ? Center(
                        child: Text(
                    ...
                    : ListView.builder(
                        ...
                        itemCount:
                            prov.busesModel.buses[widget.index].trips.length ??
                                0,
                              ...
                              child: Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(
                                      prov.busesModel.buses[widget.index]
                                          .trips[index].routeName,
                                      style: TextStyle(fontSize: 20.0),
                                    ),
                                  ),
                                  Text(prov.busesModel.buses[widget.index]
